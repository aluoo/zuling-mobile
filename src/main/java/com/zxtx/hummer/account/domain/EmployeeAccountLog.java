...
public class EmployeeAccountLog implements Serializable {
    ...
    @ApiModelProperty("'发行佣金累计收益-变动前'(分)")
    private Long accIssueIncomeBefore;

    @ApiModelProperty("'发行佣金累计收益-变动金额'(分)")
    private Long accIssueIncomeChange;

    @ApiModelProperty("'发行佣金累计收益-变动后'(分)")
    private Long accIssueIncomeAfter;

    @ApiModelProperty("'服务费佣金累计收益-变动前'(分)")
    private Long accServiceFeeIncomeBefore;

    @ApiModelProperty("'服务费佣金累计收益-变动金额'(分)")
    private Long accServiceFeeIncomeChange;

    @ApiModelProperty("'服务费佣金累计收益-变动后'(分)")
    private Long accServiceFeeIncomeAfter;
